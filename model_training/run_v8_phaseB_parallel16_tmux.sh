...
RUN_ID="${1:-v8_phaseB_parallel16_$(date +%Y%m%d_%H%M%S)}"
ROOT="experiments/${RUN_ID}"
STAGE="${V8_PHASEB_STAGE:-stageB_parallel16_end_to_end_embedding}"
...
c5_10_20_d16_s20260519:5-10-20:16:20260519;\
c5_10_20_d24_s20260519:5-10-20:24:20260519;\
c5_10_20_d32_s20260519:5-10-20:32:20260519;\
c4_8_16_d16_s20260519:4-8-16:16:20260519;\
c4_8_16_d24_s20260519:4-8-16:24:20260519;\
c4_8_16_d32_s20260519:4-8-16:32:20260519;\
c3_6_12_d16_s20260519:3-6-12:16:20260519;\
c3_6_12_d24_s20260519:3-6-12:24:20260519;\
c3_6_12_d32_s20260519:3-6-12:32:20260519;\
c6_12_24_d16_s20260519:6-12-24:16:20260519;\
c6_12_24_d24_s20260519:6-12-24:24:20260519;\
c6_12_24_d32_s20260519:6-12-24:32:20260519;\
c5_10_20_d16_s20260520:5-10-20:16:20260520;\
c5_10_20_d24_s20260520:5-10-20:24:20260520;\
c4_8_16_d16_s20260520:4-8-16:16:20260520;\
c4_8_16_d24_s20260520:4-8-16:24:20260520}"

mkdir -p "${ROOT}" "${STAGE_DIR}"
printf '%s\n' "${RUN_ID}" > experiments/v8_phaseB_parallel16_active_run.txt
...
cat > "${ROOT}/launch_config.json" <<EOF
{
  ...
  "note": "V8 Phase B 16-way parallel sweep. Each tmux session owns one end-to-end embedding config."
}
EOF

IFS=';' read -r -a CONFIG_ARRAY <<< "${CONFIGS}"
if [[ "${#CONFIG_ARRAY[@]}" -ne 16 ]]; then
  echo "expected 16 configs, got ${#CONFIG_ARRAY[@]}" >&2
  exit 2
fi
...
for item in "${CONFIG_ARRAY[@]}"; do
  ...
  SESSION="v8b16_${RUN_TAG}_${index}"
  mkdir -p "${OUT_DIR}"
