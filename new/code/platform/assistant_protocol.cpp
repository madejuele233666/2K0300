...
std::string EncodeAssistantTelemetry(const AssistantTelemetryView& telemetry) {
    ...
    stream << "\"present\":";
    AppendJsonBool(stream, telemetry.element_evidence.cross_exit.present);
    stream << ",\"confidence\":";
    AppendJsonNumber(stream, telemetry.element_evidence.cross_exit.confidence);
    stream << ",\"forward_min_m\":";
    AppendJsonNumber(stream, telemetry.element_evidence.cross_exit.forward_min_m);
    stream << ",\"forward_max_m\":";
    AppendJsonNumber(stream, telemetry.element_evidence.cross_exit.forward_max_m);
    stream << ",\"lateral_min_m\":";
    AppendJsonNumber(stream, telemetry.element_evidence.cross_exit.lateral_min_m);
    stream << ",\"lateral_max_m\":";
    AppendJsonNumber(stream, telemetry.element_evidence.cross_exit.lateral_max_m);
    stream << ",\"sampleable_count\":" << telemetry.element_evidence.cross_exit.sampleable_count;
    stream << ",\"supporting_white_count\":"
           << telemetry.element_evidence.cross_exit.supporting_white_count;
    stream << ",\"unknown_count\":" << telemetry.element_evidence.cross_exit.unknown_count;
    stream << ",\"reason\":";
    AppendJsonString(stream, telemetry.element_evidence.cross_exit.reason);
    stream << ",\"candidate\":{\"built\":";
    AppendJsonBool(stream, telemetry.element_evidence.cross_exit.candidate.built);
    stream << ",\"takeover_enabled\":";
    AppendJsonBool(stream, telemetry.element_evidence.cross_exit.candidate.takeover_enabled);
    stream << ",\"included_in_arbitration\":";
    AppendJsonBool(stream, telemetry.element_evidence.cross_exit.candidate.included_in_arbitration);
    stream << ",\"reason\":";
    AppendJsonString(stream, telemetry.element_evidence.cross_exit.candidate.reason);
    stream << "}}}";
