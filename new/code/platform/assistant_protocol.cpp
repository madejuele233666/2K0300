...
std::string EncodeAssistantTelemetry(const AssistantTelemetryView& telemetry) {
    ...
    AppendJsonNumber(stream, telemetry.eligibility.lookahead_distance_m);
    stream << ",\"reason\":";
    AppendJsonString(stream, telemetry.eligibility.reason);
    stream << "}";
    stream << ",\"curvature\":{\"computed\":";
    AppendJsonBool(stream, telemetry.curvature.computed);
    stream << ",\"lookahead_distance_m\":";
    AppendJsonNumber(stream, telemetry.curvature.lookahead_distance_m);
    stream << ",\"curvature_command\":";
    AppendJsonNumber(stream, telemetry.curvature.curvature_command);
    stream << ",\"reason\":";
    AppendJsonString(stream, telemetry.curvature.reason);
    stream << "}";
    ...
    AppendJsonNumber(stream, telemetry.yaw_control.yaw_rate_target);
    stream << "}";
