#ifndef LS2K_RUNTIME_STEERING_SCENE_FRAME_VIEW_HPP
#define LS2K_RUNTIME_STEERING_SCENE_FRAME_VIEW_HPP
...
struct BevRowsView {
    ConstArrayView<legacy::BEVSimpleRowScan> rows{};
};
...
#endif  // LS2K_RUNTIME_STEERING_SCENE_FRAME_VIEW_HPP
